function [data_all_win_freq] = reshape_onesubj_freq(data_all, win_samp, fsamp, channels)
    ...
    for chan = channels   
        ...
        pxx_useful = log10(pxx');                                 % Logarithmic value of pxx
        ...
        pxx_useful_norm = pxx_useful ./ max(abs(pxx_useful), [], 2); % Normalize the PSD

        pxx_useful_norm = pxx_useful_norm - mean(pxx_useful_norm, 2); % Mean subtraction
